...
/* package category-theory-for-programmers-0.1.0.0 */
#ifndef VERSION_category_theory_for_programmers
#define VERSION_category_theory_for_programmers "0.1.0.0"
#endif /* VERSION_category_theory_for_programmers */
#ifndef MIN_VERSION_category_theory_for_programmers
#define MIN_VERSION_category_theory_for_programmers(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  1 || \
  (major1) == 0 && (major2) == 1 && (minor) <= 0)
#endif /* MIN_VERSION_category_theory_for_programmers */
...
#define CURRENT_COMPONENT_ID "category-theory-for-programmers-0.1.0.0-CkRFxjocNRxA7KKB5mtIOA-category-theory-for-programmers"
